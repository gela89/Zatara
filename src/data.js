...
export const data = [
  ...
  },
  {
    ...
    price: 2000,
    description:
      "თანამედროვე L-ფორმის სამზარეულო კონტრასტული ფერებით და პრაქტიკული დიზაინით.",
    details: {
  ...
  },
  {
    ...
    price: 1100,
    description:
      "თანამედროვე და მრავალფუნქციური TV კედელი ინტეგრირებული სათავსოებით და დეკორატიული ელემენტებით.",
    details: {
...

  {
    id: 9,
    title: "SP-2 | გარდერობი | Aristo სტილი",
    img: 'https://res.cloudinary.com/dluqegrav/image/upload/v1751278227/FB_IMG_1746686130069_mmratz.jpg',
    category: "Wardboards",
    price: 1350,
    description:
      "თანამედროვე დიზაინის, კომპაქტური და ფუნქციური გარდერობი ხის ეფექტით და მუქი სახელურებით, რომელიც იდეალურია სადარბაზოსთვის ან მისაღები ოთახისთვის. გარდერობს აქვს ზედა კუპეები და ორი ქვედა უჯრა, რაც უზრუნველყოფს საკმარის სათავსო სივრცეს.",
    details: {
      material: "ლამინირებული MDF / ხის ეფექტის ზედაპირი",
      producer: "Aristo (სტილით, ან მსგავსი მწარმოებელი)",
      dimensions: {
        general:
          "სურათზე მოცემული გარდერობი შექმნილია სივრცის ინდივიდუალური ზომების მიხედვით; ზუსტი ზომები არ არის მითითებული, მაგრამ ვიზუალურად განიერი და მაღალია.",
      },
      colors: [
        "ნათელი ხისფერი (ნატურალური ხის ტექსტურა)",
        "მუქი ნაცრისფერი/ანტრაციტი (კედლის ფერი)",
      ],
      features: [
        "სტანდარტული გასაღებიანი კარები (არ არის მოცურებადი)",
        "ორი ინტეგრირებული უჯრა ქვედა ნაწილში",
        "ინტეგრირებული განათება ჭერზე (ფარული)",
        "თანამედროვე მინიმალისტური დიზაინი",
        "კომბინირებული მასალები: ხე-ტექსტურა და სადა ზედაპირები",
        "მუქი, გრძელი სახელურები",
      ],
    },
  },
];
